...
const CORS_HEADERS = {
  ...
  'access-control-allow-headers': 'authorization,content-type,x-personal-monitor-secret'
};
...
function requestSecret(request) {
  ...
  const headerSecret = String(request.headers.get('x-personal-monitor-secret') || '').trim();
