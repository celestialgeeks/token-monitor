...
test('sharedDataDir uses TOKEN_MONITOR_SHARED_DIR override', () => {
  ...
  process.env.TOKEN_MONITOR_SHARED_DIR = path.join(os.tmpdir(), 'personal-monitor-test');
  try {
