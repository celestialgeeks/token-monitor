...
var languageStorageKey = "routed-monitoring-site-language";

var translations = {
  en: {
    "meta.title": "Routed Monitoring: AI Tools usage at a glance",
    "meta.description": "Routed Monitoring is a local-first desktop app for live tokens, cost, limits, sessions, and history across 28+ AI coding tools.",
    "meta.ogTitle": "Routed Monitoring",
    "meta.ogDescription": "Live tokens, cost, limits, sessions, and history across 28+ AI coding tools.",
    "nav.skip": "Skip to content",
    "nav.primary": "Primary",
    "nav.home": "Routed Monitoring home",
    "nav.language": "Language",
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "Star Routed Monitoring on GitHub",
    ...
    "hero.preview": "Preview of the Routed Monitoring Home dashboard",
    ...
    "cta.download.aria.generic": "Download the latest Routed Monitoring release",
    "cta.download.aria.mac": "Download Routed Monitoring for macOS",
    "cta.download.aria.windows": "Download Routed Monitoring for Windows",
    "cta.download.aria.linux": "Download Routed Monitoring for Linux",
    ...
    "feature.lede": "Walk through four of the nine real Routed Monitoring views, or choose a view directly.",
    "feature.views": "Routed Monitoring product views",
    ...
    "dash.lede": "Turn on opt-in history and Routed Monitoring opens a full dashboard window: a GitHub-style activity heatmap with streaks, plus per-tool and per-model usage stacked over time in bar and K-line views, rolled up across all your devices.",
    "mock.you": "YOU",
    "mock.newest": "↕ Newest",
    ...
    "privacy.body": "Routed Monitoring syncs only the fields needed to show totals, costs, tool and model breakdowns, and normalized account limit status.",
  ...
  "zh-TW": {
    "meta.title": "Routed Monitoring：AI Tools 用量一眼看清",
    "meta.description": "Routed Monitoring 是本地優先的桌面 App，可即時查看 28+ 種 AI coding 工具的 token、成本、限額、session 與歷史。",
    "meta.ogTitle": "Routed Monitoring",
    "meta.ogDescription": "即時查看 28+ 種 AI coding 工具的 token、成本、限額、session 與歷史。",
    "nav.skip": "跳到內容",
    "nav.primary": "主要導覽",
    "nav.home": "Routed Monitoring 首頁",
    "nav.language": "語言",
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "在 GitHub 上為 Routed Monitoring 加星",
    "nav.sections": "區塊導覽",
    "nav.features": "功能",
    "nav.privacy": "隱私",
    "nav.download": "下載",
    ...
    "hero.preview": "Routed Monitoring Home dashboard 預覽",
    "hero.periods": "用量期間",
    "cta.download": "下載最新版本",
    ...
    "cta.download.aria.generic": "下載最新版 Routed Monitoring",
    "cta.download.aria.mac": "下載 macOS 版 Routed Monitoring",
    "cta.download.aria.windows": "下載 Windows 版 Routed Monitoring",
    "cta.download.aria.linux": "下載 Linux 版 Routed Monitoring",
    ...
    "feature.views": "Routed Monitoring 產品視圖",
    ...
    "dash.lede": "開啟可選的歷史收集，Routed Monitoring 會打開完整的 dashboard 視窗：GitHub 風格的活動熱力圖與連續天數，加上隨時間堆疊的各工具、各模型用量，提供長條圖與 K 線兩種檢視，並彙整你所有裝置。",
    "mock.you": "你",
    "mock.newest": "↕ 最新",
    ...
    "privacy.body": "Routed Monitoring 只同步顯示總量、成本、工具與模型拆分，以及標準化帳戶限制所需的欄位。",
  ...
  "zh-CN": {
    "meta.title": "Routed Monitoring：AI Tools 用量一眼看清",
    "meta.description": "Routed Monitoring 是本地优先的桌面 App，可实时查看 28+ 种 AI coding 工具的 token、成本、限额、session 与历史。",
    "meta.ogTitle": "Routed Monitoring",
    "meta.ogDescription": "实时查看 28+ 种 AI coding 工具的 token、成本、限额、session 与历史。",
    "nav.skip": "跳到内容",
    "nav.primary": "主要导航",
    "nav.home": "Routed Monitoring 首页",
    "nav.language": "语言",
    "nav.github": "GitHub",
    "nav.star": "Star",
    "nav.githubStar": "在 GitHub 上为 Routed Monitoring 加星",
    "nav.sections": "区块导航",
    "nav.features": "功能",
    "nav.privacy": "隐私",
    "nav.download": "下载",
    ...
    "hero.alsoAvailable": "其他版本",
    "hero.preview": "Routed Monitoring Home dashboard 预览",
    "hero.periods": "用量期间",
    "cta.download": "下载最新版本",
    ...
    "cta.download.aria.generic": "下载最新版 Routed Monitoring",
    "cta.download.aria.mac": "下载 macOS 版 Routed Monitoring",
    "cta.download.aria.windows": "下载 Windows 版 Routed Monitoring",
    "cta.download.aria.linux": "下载 Linux 版 Routed Monitoring",
    "cta.github": "查看 GitHub",
    ...
    "feature.views": "Routed Monitoring 产品视图",
    ...
    "dash.lede": "开启可选的历史收集，Routed Monitoring 会打开完整的 dashboard 窗口：GitHub 风格的活动热力图与连续天数，加上随时间堆叠的各工具、各模型用量，提供柱状图与 K 线两种视图，并汇总你所有设备。",
    "mock.you": "你",
    "mock.newest": "↕ 最新",
    ...
    "privacy.body": "Routed Monitoring 只同步显示总量、成本、工具与模型拆分，以及标准化账号限制所需的字段。",
...
function applyLanguage(language) {
  ...
  if (typeof window.CustomEvent === "function") window.dispatchEvent(new CustomEvent("routed-monitoring-languagechange", { detail: { language: active } }));
}
