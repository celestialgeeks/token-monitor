...
var translations = {
  en: {
    ...
    "meta.description": "Routed Monitoring is a local-first desktop app for live tokens, cost, limits, sessions, and history across 29+ AI coding tools.",
  ...
  "zh-TW": {
    ...
    "meta.description": "Routed Monitoring 是本地優先的桌面 App，可即時查看 29+ 種 AI coding 工具的 token、成本、限額、session 與歷史。",
    "meta.ogTitle": "Routed Monitoring",
  ...
  "zh-CN": {
    "meta.title": "Routed Monitoring：AI Tools 用量一眼看清",
    "meta.description": "Routed Monitoring 是本地优先的桌面 App，可实时查看 29+ 种 AI coding 工具的 token、成本、限额、session 与历史。",
    "meta.ogTitle": "Routed Monitoring",
